...
router.get('/review/user/:id', isAuthMiddleware, reviewController.getAllByUserId)
router.get('/review/artist/:id', isAuthMiddleware, reviewController.getAllByArtistId)
